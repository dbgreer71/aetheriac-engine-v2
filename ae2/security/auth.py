...
class AuthManager:
    ...
    def _initialize_default_users(self) -> None:
        ...
        operator_user = create_default_user(
            username="operator",
            email="operator@aetheriac.local",
            role=Role.OPERATOR
        )
    ...
    def load_users_from_file(self, file_path: Path) -> None:
        ...
        for user_data in users_data:
            try:
                ...
                logger.error(f"Failed to load user {user_data.get('username', 'unknown')}: {e}")
