...
class Settings(BaseSettings):
    ...
    concepts_dir: Path = Field(default=Path("data/concepts"), description="Concepts directory")
    playbooks_dir: Path = Field(default=Path("data/playbooks"), description="Playbooks directory")
    ...
    @validator('base_dir', 'data_dir', 'index_dir', 'rfc_dir', 'concepts_dir', 'playbooks_dir')
