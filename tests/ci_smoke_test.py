...
def test_auto_ospf_route_smoke():
...
def test_ospf_step_hash_deterministic():
...
def test_ospf_vendor_detection():
...
def test_ospf_interface_extraction():
...
def test_ospf_abstain_precedence():
...
def test_ospf_confidence_scores():
...
def test_ospf_reasons_in_notes():
...
def test_ospf_step_hash_consistency():
